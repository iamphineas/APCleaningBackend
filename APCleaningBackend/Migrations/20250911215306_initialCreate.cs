    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CleanerDetailsID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleanerDetails", x => x.CleanerDetailsID);
                    table.ForeignKey(
                        name: "FK_CleanerDetails_AspNetUsers_CleanerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverDetails", x => x.DriverDetailsID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedCleanerID = table.Column<int>(type: "int", nullable: true),
                    ServiceTypeID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Booking_CleanerDetails_AssignedCleanerID",
                        column: x => x.AssignedCleanerID,
                        principalTable: "CleanerDetails",
                        principalColumn: "CleanerDetailsID");
                    table.ForeignKey(
                        name: "FK_Booking_DriverDetails_AssignedDriverID",
                        column: x => x.AssignedDriverID,
                        principalTable: "DriverDetails",
                        principalColumn: "DriverDetailsID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Booking_AssignedCleanerID",
                table: "Booking",
                column: "AssignedCleanerID");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_AssignedDriverID",
                table: "Booking",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CleanerDetails_CleanerId",
                table: "CleanerDetails",
                column: "CleanerId");
